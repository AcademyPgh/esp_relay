...
void setup() {
  ...
  // esphome:
  //   name: 4-port-relay
  //   friendly_name: 4 Port Relay
  //   min_version: 2024.12.4
  //   build_path: build/4-port-relay
  //   area: ''
  //   platformio_options: {}
  //   includes: []
  //   libraries: []
  //   name_add_mac_suffix: false
  App.pre_setup("4-port-relay", "4 Port Relay", "", "", __DATE__ ", " __TIME__, false);
  // switch:
  // logger:
  //   level: VERBOSE
  //   id: logger_logger_id
  ...
  // wifi:
  //   ap:
  //     ssid: 4-Port-Relay Fallback Hotspot
  //     password: Tp6KpfFp1KtZ
  //     id: wifi_wifiap_id
  //     ap_timeout: 1min
  ...
  //     id: wifi_wifiap_id_2
  //     priority: 0.0
  //   use_address: 4-port-relay.local
  wifi_wificomponent_id = new wifi::WiFiComponent();
  wifi_wificomponent_id->set_use_address("4-port-relay.local");
  {
  ...
  wifi_wifiap_id.set_ssid("4-Port-Relay Fallback Hotspot");
  wifi_wifiap_id.set_password("Tp6KpfFp1KtZ");
  ...
  // ota.esphome:
  //   platform: esphome
  //   password: 350cbc745a72ad42a9230af55f4fa439
  //   id: esphome_esphomeotacomponent_id
  //   version: 2
  //   port: 3232
  esphome_esphomeotacomponent_id = new esphome::ESPHomeOTAComponent();
  esphome_esphomeotacomponent_id->set_port(3232);
  esphome_esphomeotacomponent_id->set_auth_password("350cbc745a72ad42a9230af55f4fa439");
  ...
  // api:
  //   encryption:
  //     key: Hq03eLh5CVx4Ej3n4yeKvdHfxVWJOvaIMTgF4KeiGJo=
  //   id: api_apiserver_id
  //   port: 6053
  //   password: ''
  //   reboot_timeout: 15min
  ...
  api_apiserver_id->set_noise_psk({30, 173, 55, 120, 184, 121, 9, 92, 120, 18, 61, 231, 227, 39, 138, 189, 209, 223, 197, 85, 137, 58, 246, 136, 49, 56, 5, 224, 167, 162, 24, 154});
  // esp32:
  ...
  gpio_gpioswitch_id->set_name("Relay 1");
  gpio_gpioswitch_id->set_object_id("relay_1");
